...
exports.handler = async (event, context) => {
  let reason = event.ResponseStatus === 'FAILED' ? ('See the details in CloudWatch Log Stream: ' + context.logStreamName) : undefined;
  ...
  console.log('axios put event to: ', event.ResponseURL);
